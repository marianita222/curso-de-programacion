...
if opcion == "linterna":
  ...
  print()
  opcion = input("quieres *seguir* el camino o *buscar* entre los arboles lo que hizo el ruido?").lower()
  print()
  if opcion == "buscar":
      print("buscaste donde estaba ese misterioso ruido,pero escuchaste el mismo sonido detras de ti")
      opcion = input("deseas *CORRER* o *VOLTEAR*").lower()
      print()
  if opcion.lower() == "correr":
         ...
         opcion = input("despertaste mareado y lo unico que tienes a tu alrededor es una casa abandonada, deseas entrar? *si* *no*").lower()
         print()
  if opcion.lower() == "si":
        print("entraste a la casa abandonada, observaste que todo estaba hecho pedazos y muy tenebroso")
        opcion = input("quieres pasar la noche en la casa abandonada? *pasar la noche* *dejar la casa*").lower()
        if opcion.lower() == "pasar la noche":
